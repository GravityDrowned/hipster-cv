...
\bg{cvgreen}{white}{\textbf{Personal}} \\
...
\bg{cvgreen}{white}{\textbf{Areas of specialization}} \\
...
\bg{cvgreen}{white}{\textbf{Languages}}
\bigskip
...
\bg{cvgreen}{white}{\textbf{Interests}}\\
...
\bg{cvgreen}{white}{\textbf{Recent Technologies}} \\
...
\bg{cvgreen}{white}{\textbf{Programming Languages}} \\
\begin{minipage}[t]{0.3\textwidth}
\begin{tabular}{r @{\hspace{0.5em}}l}
...
\bg{cvgreen}{white}{\textbf{Contact Information  \& Links}}\\
\scalebox{0.8}{
\iconcross{\Huge}{white}{labelcolour}
{\href{https://github.com/GravityDrowned}{\faGithub}}
